 ...
 */
package occ.ues.edu.sv.bachestpi.entity;
 ...
 */
@Entity
@Table(name = "objeto_estado", catalog = "tpi", schema = "public")
@NamedQueries({
...
public class ObjetoEstado implements Serializable {
    ...
    public String toString() {
        return "occ.ues.edu.sv.bachestpi.entity.ObjetoEstado[ idObjetoEstado=" + idObjetoEstado + " ]";
    }
